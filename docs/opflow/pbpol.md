...
```math
\begin{aligned}
\dfrac{\partial{(S^2_f)}}{\partial{V_{f}}} &= 2P_f(2G_{ff}V_{f} + G_{ft}V_{t}\cos(\theta_{f}-\theta_t) + V_{t}B_{ft}\sin(\theta_{f}-\theta_t)) 
...
\dfrac{\partial{(S^2_t)}}{\partial{V_f}} &= 2P_t(V_{t}(G_{tf}\cos(\theta_{t}-\theta_f) + B_{tf}\sin(\theta_{t}-\theta_f))) 
                                          + 2Q_t(V_{t}(G_{tf}\sin(\theta_{t}-\theta_f) - B_{tf}\cos(\theta_{t}-\theta_f)))\\
...
\dfrac{\partial{(S^2_f)}}{\partial{\theta_{f}}} &= 2P_f(-V_{f}V_{t}G_{ft}\sin(\theta_{f}-\theta_t) + V_{f}V_{t}B_{ft}\cos(\theta_{f}-\theta_t)) 
