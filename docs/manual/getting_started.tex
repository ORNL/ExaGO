...
\exago is currently only built on MacOSX and Linux operating systems and requires C++17 compliant compiler.
We build \exago on x86\_64, Arm, and IBM Power9 architectures.
...
\exago may be acquired via the ORNL GitHub \href{https://github.com/ORNL/exago}{repository}:

\begin{lstlisting}[language=bash]
> git clone https://github.com/ORNL/exago.git exago
...
\begin{table}[h]
  ...
  \begin{tabular}{|l|c|c|l|}
    ...
    \hiop & $\geq 1.0$ & & Prefer dynamically linked \\ \hline
    \raja & $\geq 0.14$ & & \\ \hline
    \href{https://github.com/LLNL/umpire}{Umpire \cite{umpire}} & $\geq 6.0$ & & Only when RAJA is enabled \\ \hline
    \magma & $\geq 2.6.2$ & & Only when GPU acceleration is enabled \\ \hline
    \cuda &  $\geq 11.4$ & & Only when NVIDIA support is enabled \\ \hline
    \rocm &  $\geq 6.4$ & & Only when AMD accelerators support is enabled \\
    \hline
  \end{tabular}
