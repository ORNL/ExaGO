...
int LINEParamsRajaHiop::destroy(OPFLOW opflow) {
  ...
  // h_allocator_.deallocate(bust_idx); // TODO: Fix free error
  // h_allocator_.deallocate(jacf_idx); // TODO: Fix free error
  // h_allocator_.deallocate(jact_idx); // TODO: Fix free error
  // h_allocator_.deallocate(hesssp_idx); // TODO: Fix free error
